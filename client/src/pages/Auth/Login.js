...
const Login = () => {
  ...
  return (
    <div>
      ...
      {init && (
        <div className="register-container h-screen flex bg-[#212122]">
          <div className="w-2/5 p-10 flex items-start justify-between flex-col ">
            <div>
              <Link className="hover:text-cyan-400 text-2xl" to="/">
                WebAuth
              </Link>
            </div>
            <div className="max-w-md w-full form-data ">
